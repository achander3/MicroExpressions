...
num_people = 26
num_channels = 1  # BW images have 1 channels
height = 224
width = 224
...
transform = transforms.Compose([
    ...
    transforms.ToTensor(),
    transforms.Normalize(mean=[0.485], std=[0.229])  # Mean and std for grayscale images
])

# Define paths to your dataset and CSV file
data_root = 'D:/NCSU/CS-B/project/Data/CASME-2/'
train_csv_file = 'D:/NCSU/CS-B/project/Data/CASME-2/CASME2_train.csv'
test_csv_file = 'D:/NCSU/CS-B/project/Data/CASME-2/CASME2_test.csv'
